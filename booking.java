 ...
 */
    ...
    public void makeBooking() {
        ...
        // يقوم الكود بالتحقق من وجود حجز سابق للمريض مع الطبيب المعطي،
        //وإذا تم العثور على حجز مطابق، 
        //يتم طباعة رسالة وإنهاء الحلقة.
     ...
     */
    //يقوم الكود بتحديث معلومات حجز طبيب معين إذا تم العثور على حجز مطابق، 
    //وإلا يتم طباعة رسالة تفيد بعدم وجود حجز مع الطبيب المدخل
    ...
    //هذه الدالة تقوم بالتحقق مما إذا كانت قائمة الحجوزات غير فارغة.isEmpty()
    public static boolean hasBooking() {
         return !bookingList.isEmpty();//تعطي دايما فولس فيتحول اذا في
    }
