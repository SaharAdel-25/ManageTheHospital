...
public class Operations {
        //مشتركة بين جميع الكائنات المنشأة من هذا الصنف.
    static ArrayList<Doctors> doctorList =new ArrayList<>();
    static ArrayList<Patients> patientList =new ArrayList<>();
    static ArrayList<String>departmentList =new ArrayList<>();//للاحتفاظ باخر قيمة 
    ...
    public void addPatient() {
        ...
        do {
            do{
                ...
                ID = input.nextInt();
                input.nextLine(); // استهلاك حرف السطر الجديد
                if(ID <=0){
